...
public class Like extends FrameLayout {
        ...
        switch (event.getAction()) {
            case MotionEvent.ACTION_DOWN:
                ...
                if (interval < INTERVAL) {//小于1秒，拦截事件，并做处理
                    ...
                    //设置图片资源
                    imageView.setImageDrawable(getResources().getDrawable(R.drawable.like_normal));
     ...
     * @return
     */
    public static Animator scale(View view, String propertyName, float from, float to, long time, long delayTime) {
    ...
    public static Animator translationY(View view, float from, float to, long time, long delayTime) {
        ObjectAnimator translation = ObjectAnimator.ofFloat(view
                , "translationY"
                , from, to);
        translation.setInterpolator(new LinearInterpolator());
     ...
     * @return
     */
    public static Animator alpha(View view, float from, float to, long time, long delayTime) {
        ObjectAnimator translation = ObjectAnimator.ofFloat(view
                , "alpha"
                , from, to);
        translation.setInterpolator(new LinearInterpolator());
    ...
    public static Animator rotation(View view, long time, long delayTime, float... values) {
